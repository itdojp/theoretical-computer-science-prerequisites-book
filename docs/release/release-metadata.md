...
| 項目 | 値 |
|---|---|
| 教材名 | 理論計算機科学を読むための数学・証明・アルゴリズム基礎 |
| バージョン | v1.0 |
| ステータス | 初回安定版 |
| リリース日 | 2026-06-29 |
| 配布物 | `theoretical-computer-science-prerequisites-book-v1.0.zip` |
| ライセンス | CC BY-NC-SA 4.0 |
| 著作者表記 | ITDO Inc.（株式会社アイティードゥ） |

## 公開先で更新する項目

公開リポジトリ投入用として、公開先情報を以下の通り固定しています。
...
v1.0 は、次の範囲を初回安定版として固定します。

- 第1章〜第13章の章番号とファイル名。
- Core / Standard / Extended の分類。
